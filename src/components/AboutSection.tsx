      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-muted-foreground">
                Full-stack developer with MERN expertise, experienced in building impactful projects like PrepMate, an accessible notes application with AI features, and MegaMart, a secure e-commerce platform — both optimized for performance and user engagement.
                Also bring strong competitive coding prowess, with a passion for crafting clean architectures and intuitive UI/UX focused on elevating user experience.
              </p>
            </motion.div>
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold">Bardaval Govind</h3>
              <p className="text-muted-foreground">
            ...
            >
              <Button className="gap-2" asChild onClick={handledownload}>
                <a href={resumeUrl} download="Bardaval_Govind_CV.pdf">
